...
/// <remarks>
///     Defined by
///     <see href="https://tools.ietf.org/html/rfc5155#section-3">
...
public class NSEC3Record : ResourceRecord
{
    ...
    public override void ReadData(WireReader reader, int length)
    {
        ...
        while (reader.Position < end) Types.AddRange(reader.ReadBitmap().Select(t => (DnsType)t));
    }
