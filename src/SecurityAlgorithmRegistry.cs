...
///     <see href="https://www.iana.org/assignments/dns-sec-alg-numbers/dns-sec-alg-numbers.xhtml#dns-sec-alg-numbers-1" />
///     .
/// </remarks>
...
public static class SecurityAlgorithmRegistry
{
    ...
    {
        if (Algorithms.TryGetValue(algorithm, out var metadata)) return metadata;
